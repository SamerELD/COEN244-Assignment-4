...
public:
    ...
    //Bonus question: adds in a set of vertices; returns bool if added //successfully
    ...
    //Bonus question: removes a set of edges; as a result, some nodes may remain //as orphan.
    ...
    virtual void display(Vertex& v) const = 0; // displays the path that contains the edge.
